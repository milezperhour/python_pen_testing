...
# This tool is meant to crave out image files from HTTP traffic
# We use OpenCV to attempt to detect human faces in the images

# To use, open terminal and type:
# apt-get install python-opencv python-numpy python-scipy

# And a facial detection training file:
